...
extern void aes128_enc(__m128i *key_schedule, uint8_t *plain_text, uint8_t *cipher_text);
extern void aes128_dec(__m128i *key_schedule, uint8_t *cipher_text, uint8_t *plain_text);
...
int main(void)
{
	...
	uint8_t cipher[]  = {219, 120, 206, 123, 133, 59, 15, 54, 213, 192, 230, 100, 4, 118, 26, 162};
